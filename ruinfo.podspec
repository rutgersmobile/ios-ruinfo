#
#  Be sure to run `pod spec lint ruinfo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Russ Frank" => "russ.frank@rutgers.edu", "other author" => "email@address.com" }
  # s.author       = 'Russ Frank', 'other author'
  ...
  s.source       = { :git => "https://github.com/rumobile/ruinfo.git", :tag => "0.0.1" }
